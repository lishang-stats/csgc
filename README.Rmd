...
![equation](https://latex.codecogs.com/png.latex?A_{ij}=A_{ji}\overset{i.i.d.}{\sim} \mathop{\mathrm{Be}}\left(k_{z_iz_j}\right))
...
![equation](https://latex.codecogs.com/png.latex?A_{ij}=A_{ji}\overset{i.i.d.}{\sim}%20\mathop{\mathrm{Po}}\left(\theta_i%20\theta_j%20k_{z_iz_j}\right))
