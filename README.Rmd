...
![equation](https://latex.codecogs.com/png.image?\dpi{200}A_{ij}=A_{ji}\overset{i.i.d.}{\sim} \mathop{\mathrm{Po}}(\theta_i \theta_j k_{z_iz_j}, \quad\text{for $1\leq i,j\leq n, i\ne j$}). We can generate matrix $A$ and $P$ from $K$ and $\Theta$ and $z$.
